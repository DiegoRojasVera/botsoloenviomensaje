...
import { AnyMediaMessageContent, AnyMessageContent, MediaGenerationOptions, MessageContentGenerationOptions, MessageGenerationOptions, MessageGenerationOptionsFromContent, MessageUserReceipt, WAMessage, WAMessageContent, WAProto } from '@bot-whatsapp/provider-baileys/node_modules/@whiskeysockets/baileys/lib/Types';
import { MediaDownloadOptions } from '@bot-whatsapp/provider-baileys/node_modules/@whiskeysockets/baileys/lib/Utils/messages-media';
/**
...
export declare const generateLinkPreviewIfRequired: (text: string, getUrlInfo: MessageGenerationOptions['getUrlInfo'], logger: MessageGenerationOptions['logger']) => Promise<import("@bot-whatsapp/provider-baileys/node_modules/@whiskeysockets/baileys/lib/Types").WAUrlInfo | undefined>;

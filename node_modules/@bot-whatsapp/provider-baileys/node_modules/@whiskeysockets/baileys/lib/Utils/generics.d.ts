...
import { BaileysEventEmitter, BaileysEventMap, WACallUpdateType, WAVersion } from '@bot-whatsapp/provider-baileys/node_modules/@whiskeysockets/baileys/lib/Types';
import { BinaryNode } from '@bot-whatsapp/provider-baileys/node_modules/@whiskeysockets/baileys/lib/WABinary';
...
export declare const bindWaitForConnectionUpdate: (ev: BaileysEventEmitter) => (check: (u: Partial<import("@bot-whatsapp/provider-baileys/node_modules/@whiskeysockets/baileys/lib/Types").ConnectionState>) => boolean | undefined, timeoutMs?: number) => Promise<void>;

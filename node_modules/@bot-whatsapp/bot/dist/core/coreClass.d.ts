...
import { GlobalState, SingleState } from '@bot-whatsapp/bot/src/context';
import FlowClass from '@bot-whatsapp/bot/src/io/flowClass';
import { BlackList, Queue } from '@bot-whatsapp/bot/src/utils';
import { delay } from '@bot-whatsapp/bot/src/utils/delay';
...
declare class CoreClass extends EventEmitter {
    ...
    handleMsg: (messageCtxInComming: {
        ...
        createCtxMessage: (payload: {
            ...
            delay: number;
            keyword: null;
        }, index?: number) => import("@bot-whatsapp/bot/src/types").TContext;
        clearQueue: () => void;
        endFlow: (flag: {
            endFlow: any;
            fallBack?: boolean;
